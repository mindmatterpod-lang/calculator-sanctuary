...
const siteJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      url: "/",
      description:
        "CalculatorHub builds free, accurate online calculators for finance, health, education and science.",
    },
  ],
};
  ...
  head: () => ({
    meta: [
      ...
      // Google Search Console verification
      {
        ...
        content:
          "JabNucFR2y2UDb547dLKgD0biq56WoR-IMVhH9mgZrY",
      },
...
function Home() {
  ...
  const results = useMemo(
    () =>
      query.trim()
        ? searchCalculators(query).slice(0, 12)
        : [],
    [query]
  );
    ...
    <div>
      ...
      <section className="relative overflow-hidden px-4 pb-16 pt-16 sm:px-6 sm:pt-24">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1
            className="animate-rise mt-6 text-balance font-display text-4xl font-bold leading-[1.05] sm:text-6xl"
          ...
          >
            One website. Hundreds of powerful calculators. Fast,
            accurate, free, and beautifully designed.
          </p>
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The calculators people reach for every single day.
        </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Eleven collections, from mortgages to molar mass.
            </p>
          </div>
