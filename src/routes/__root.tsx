    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That calculator or page doesn't exist — try browsing all calculators instead.
        </p>
        <div className="mt-6">
          <Link
            to="/calculators"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CalculatorHub — Every Calculator You'll Ever Need" },
      {
        name: "description",
        content:
          "Hundreds of fast, accurate, free calculators for finance, health, maths, science and daily life.",
      },
      { property: "og:site_name", content: "CalculatorHub" },
